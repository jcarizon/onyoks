...
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
<div class="html_content"><p style="margin:1em 0.36em 0.36em 0em;text-align:Center;"><span style="font-family:'Open Sans','Microsoft New Tai Lue';font-size:2.857em;color:rgba(231,76,61,1);">Login</span></p></div>
<div style="height:0px;width:0px;overflow:hidden;-webkit-margin-top-collapse: separate;"></div>
	...
	<form id="ContactForm0" class="form-horizontal" role="form" method="post" action="" style="margin: 0 auto;">
		...
		<div class="form-group">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 control-label">
				<input type="submit" class="pull-left btn btn-md btn-default" id="submitform" name="submit" value="Submit" />
			</div>
		</div>
		<div style="clear: both;"></div>

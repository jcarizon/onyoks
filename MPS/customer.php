      ...
      <header id="ttr_header">
         <div id="ttr_header_inner">
            ...
            <div class="ttr_headershape01">
               <div class="html_content"><a href="index.php" class="tt_link" target="_self"><span style="font-family:'Open Sans','Arial';float: right; font-weight:700;color:rgba(149,149,149,1);">Logout</span></a></p></div>
            </div>
         </div>
      </header>
